...
HD_PWD='E:/Xilinx/project/DecisionTree_IPC_10k/DecisionTree_IPC_10k.runs/bram_40_512_da_level4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_40_512_da_level4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_40_512_da_level4.tcl
