...
HD_PWD='E:/Xilinx/project/DecisionTree_ACL_10K/DecisionTree_ACL_10K.runs/bram_40_998_sada_level6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_40_998_sada_level6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_40_998_sada_level6.tcl
