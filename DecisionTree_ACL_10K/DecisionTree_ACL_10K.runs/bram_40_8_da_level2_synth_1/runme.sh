...
HD_PWD='E:/Xilinx/project/IPC_10k_test/IPC_10k_test.runs/bram_40_8_da_level2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_40_8_da_level2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_40_8_da_level2.tcl
