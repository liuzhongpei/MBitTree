...
HD_PWD='E:/Xilinx/project/DecisionTree_ACL_10K/DecisionTree_ACL_10K.runs/bram_171_da_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_171_da.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_171_da.tcl
